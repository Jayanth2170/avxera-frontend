...
const JobApplicationPage = () => {
  ...
  const handleCancel = () => {
    navigate("/homepage") // Navigate back to homepage on cancel
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-8">
      <div
        className="relative bg-white/95 backdrop-blur-lg rounded-2xl p-8 md:p-10 shadow-2xl shadow-emerald-500/10 w-full max-w-2xl mx-auto animate-in fade-in zoom-in-90 duration-300 ease-out"
        role="main"
      >
        {/* Cancel Button */}
        <button
          ...
          aria-label="Cancel application and go back to homepage"
        >
          <X size={20} />
        </button>

        <h1 id="application-form-title" className="text-4xl font-bold text-gray-900 mb-4 text-center">
          Join Our <span className="text-emerald-600">Team</span>
        </h1>
        <p className="text-xl text-gray-600 text-center mb-8">Fill out your details to apply for a position.</p>
