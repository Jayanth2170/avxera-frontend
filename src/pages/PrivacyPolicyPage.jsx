...
const PrivacyPolicyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-8 md:px-12">
      <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-lg rounded-2xl p-6 sm:p-8 md:p-12 shadow-2xl shadow-emerald-500/10 animate-in fade-in zoom-in-90 duration-300 ease-out">
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg max-w-none text-gray-700 space-y-6">
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-4">1. Collection of Your Information</h2>
          <p>
            We may collect information about you in a variety of ways. The information we may collect on the Site
            includes:
          </p>
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-6 mb-3">Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-6 mb-3">Derivative Data</h3>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-4">2. Use of Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-4">3. Disclosure of Your Information</h2>
          <p>
            We may share information we have collected about you in certain situations. Your information may be
            disclosed as follows:
          </p>
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-6 mb-3">By Law or to Protect Rights</h3>
          <p>
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mt-6 mb-3">Third-Party Service Providers</h3>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-4">4. Security of Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-4">5. Contact Us</h2>
          <p>
