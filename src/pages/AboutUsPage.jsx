...
const AboutUsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-8 md:px-16">
      <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-lg rounded-2xl p-6 sm:p-8 md:p-12 shadow-2xl shadow-emerald-500/10 animate-in fade-in zoom-in-90 duration-300 ease-out">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 sm:mb-6">About Avexra</h1>
        <p className="text-gray-600 text-base sm:text-lg mb-6 sm:mb-8">Innovating Tomorrow, Today.</p>
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-3">Our Vision</h2>
          <p>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-3">Our Values</h2>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-8 mb-3">Our Journey</h2>
          <p>
