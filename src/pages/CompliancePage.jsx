  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16 px-8">
      <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-lg rounded-2xl p-8 md:p-12 shadow-2xl shadow-emerald-500/10 animate-in fade-in zoom-in-90 duration-300 ease-out">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 mb-6">Compliance</h1>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">1. Our Commitment to Compliance</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">2. Key Compliance Areas</h2>
          <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Data Privacy and Protection</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Information Security</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Financial Regulations</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Ethical Conduct and Anti-Corruption</h3>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">3. Regulatory Oversight</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">4. Contact Our Compliance Team</h2>
          <p>
            For any questions or concerns regarding our compliance practices, please contact our dedicated compliance
            team at:
            <br />
            Email: compliance@avexra.com
          </p>
        </div>
      </div>
    </div>
