  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16 px-8">
      <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-lg rounded-2xl p-8 md:p-12 shadow-2xl shadow-emerald-500/10 animate-in fade-in zoom-in-90 duration-300 ease-out">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 mb-6">Cookie Policy</h1>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">1. What are cookies?</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">2. How Avexra uses cookies</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">3. Third-party cookies</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">4. What are your choices regarding cookies?</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mt-10 mb-4">5. More information about cookies</h2>
          <p>
