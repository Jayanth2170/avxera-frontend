...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const userFound = storedUsers.find((user) => user.email === formData.email && user.password === formData.password)
  ...
  const handleGoogleLogin = () => {
    ...
    navigate("/homepage") // Navigate directly to homepage for Google login
  }
